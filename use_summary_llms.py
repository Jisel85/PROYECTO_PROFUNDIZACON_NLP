...
from utils.summarization import (
    get_summarization_from_openai,
    get_summarization_from_llm_gpt4all,
    get_summarization_from_huggingface_api
)
...
summary = get_summarization_from_openai(raw_text)
print(summary)
# ================================================================================================================= #
...
raw_text = judgment.get_feature_of_judgment("raw_text")
summary = get_summarization_from_llm_gpt4all(raw_text, model_name="llama-2-7b-chat", device=GPU_NAME)
print(summary)
# ================================================================================================================= #
...
raw_text = judgment.get_feature_of_judgment("raw_text")
print(raw_text)
summary = get_summarization_from_huggingface_api(raw_text)
print(summary)
# ================================================================================================================== #
